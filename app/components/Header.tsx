              ...
              <div className="hidden group-hover:block absolute top-full left-0 pt-6 w-80 z-50">
                  <div className="bg-white shadow-2xl rounded-2xl border-2 border-gray-100 overflow-hidden animate-in fade-in slide-in-from-top-2 duration-200">
                    <div className="p-3 flex flex-col gap-2">
                      <button onClick={() => onSelectPackage('Essential')} className="flex items-center gap-4 px-4 py-4 hover:bg-blue-50 rounded-xl text-left transition-colors group/item">
                      ...
                      <button onClick={() => onSelectPackage('Advanced')} className="flex items-center gap-4 px-4 py-4 hover:bg-blue-50 rounded-xl text-left transition-colors group/item">
                      ...
                      <button onClick={() => onSelectPackage('Professional')} className="flex items-center gap-4 px-4 py-4 hover:bg-blue-50 rounded-xl text-left transition-colors group/item">
